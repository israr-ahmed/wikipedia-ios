...
#### Production Builds
For production builds, you should ensure that you have `DELIVER_USER` (your Apple ID) and `HOCKEY_PRODUCTION` (Wikimedia's HockeyApp API token) environment variables set.
